          ...
          <div className={styles.contact}>
            <div className={styles.icon}>
              <svg
                ...
                viewBox="0 0 64 64"
              >
                <path d="M56 0H8C5.789 0 4 1.789 4 4v56c0 2.211 1.789 4 4 4h20V48h8v16h20c2.211 0 4-1.789 4-4V4c0-2.211-1.789-4-4-4zM28 40h-8v-8h8v8zm0-16h-8v-8h8v8zm16 16h-8v-8h8v8zm0-16h-8v-8h8v8z" />
              </svg>
            </div>
            <p>
