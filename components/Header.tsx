      ...
      <div className="container">
        <div className="navWrap">
          <Link href="/" className="logo">
            <Image src={logo_horizontal} alt="AquaPro-Détect" className="icon"/>
          </Link>
          ...
          <nav className={"nav " + nav}>
            ...
            <Link className="pill" href="/assurances-rapports" onClick={toggleBurger}>
              Assurances & Rapports
            </Link>
            ...
            <Link className="pill pillPrimary" href="/urgence-24-7" onClick={toggleBurger}>
              Urgence 24/7
            </Link>
          </nav>
        </div>
